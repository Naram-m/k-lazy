...
#
# Load saved values
gd_sc_acc = np.load("gd_hc_acc.npy")
lgd_sc_acc = np.load("lgd_hc_acc.npy")
...
plt.yticks(np.arange(-10, 0.1, 2),fontsize=12, fontweight='bold')

plt.grid(True, linestyle='--', alpha=0.6)
plt.legend(fontsize=14, frameon=False)
plt.tight_layout()
plt.savefig("hc_acc_ell1.pdf", bbox_inches='tight')  # save first
plt.show()
