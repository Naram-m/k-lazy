...
# Load saved values
gd_sc_acc = np.load("gd_hc_acc_ell2.npy")
lgd_sc_acc = np.load("lgd_hc_acc_ell2.npy")
...
plt.ylabel("Hitting Cost", fontsize=13, fontweight='bold')
plt.xticks( fontsize=12, fontweight='bold')

plt.yticks(np.arange(-100, 0.1, 20),fontsize=12, fontweight='bold')

plt.grid(True, linestyle='--', alpha=0.6)
plt.legend(fontsize=14, frameon=False)
plt.tight_layout()
plt.savefig("hc_acc_ell2.pdf", bbox_inches='tight')  # save first
plt.show()
